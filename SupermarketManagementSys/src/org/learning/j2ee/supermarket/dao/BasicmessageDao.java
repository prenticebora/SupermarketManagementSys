...
/**
 * Tb_basicmessage Data Access Object (DAO).
 * This class contains all database handling that is needed to 
 * permanently store and retrieve Tb_basicmessage object instances. 
 */
...
public class BasicmessageDao {
	...
	public List loadAll(Connection conn) throws SQLException {
		...
		String sql = "SELECT * FROM tb_basicmessage ORDER BY id ASC ";
	...
	public synchronized void create(Connection conn, Basicmessage valueObject)
		...
		try {
			sql = "INSERT INTO tb_basicmessage ( name, age, dept, "
					+ "positionId) VALUES (?, ?, ?, ?) ";
			stmt = conn.prepareStatement(sql);

			stmt.setString(1, valueObject.getName());
			stmt.setInt(2, valueObject.getAge());
			stmt.setInt(3, valueObject.getDept());
			stmt.setInt(4, valueObject.getPositionId());
	...
	public void deleteAll(Connection conn) throws SQLException {
		...
		String sql = "DELETE FROM tb_basicmessage";
		PreparedStatement stmt = null;
	...
	public int countAll(Connection conn) throws SQLException {
		...
		String sql = "SELECT count(*) FROM tb_basicmessage";
		PreparedStatement stmt = null;
		ResultSet result = null;
		int allRows = 0;
	...
	public List searchMatching(Connection conn, Basicmessage valueObject)
		...
		StringBuffer sql = new StringBuffer(
				"SELECT * FROM tb_basicmessage WHERE 1=1 ");
		...
		if (valueObject.getDept() != 0) {
			if (first) {
				first = false;
			}
			sql.append("AND dept = ").append(valueObject.getDept()).append(" ");
		}
	...
	protected void singleQuery(Connection conn, PreparedStatement stmt,
		...
		try {
			...
			if (result.next()) {
				...
				valueObject.setDept(result.getInt("dept"));
				valueObject.setPositionId(result.getInt("positionId"));

			} else {
				// System.out.println("Tb_basicmessage Object Not Found!");
				throw new NotFoundException("Tb_basicmessage Object Not Found!");
			}
		} finally {
			if (result != null)
				result.close();
	...
	protected List listQuery(Connection conn, PreparedStatement stmt)
		...
		try {
			...
			while (result.next()) {
				...
				temp.setDept(result.getInt("dept"));
