...
public class UserDao {
	 ...
	 */
	public User getObject(Connection conn, int id) throws NotFoundException,
			SQLException {
	 ...
	 */
	public List searchMatching(Connection conn, User valueObject)
			throws SQLException {
		...
		if (valueObject.getUserName() != null) {
			...
			sql.append("AND userName LIKE '").append(valueObject.getUserName())
					.append("%' ");
		}
