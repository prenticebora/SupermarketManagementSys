...
import java.util.List;
 ...
 /**
  * Position Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Position object instances. 
  */
...
public class PositionDao {
     ...
     */
    public Position getObject(Connection conn, int positionId) throws NotFoundException, SQLException {
     ...
     */
    public void load(Connection conn, Position valueObject) throws NotFoundException, SQLException {
     ...
     */
    public synchronized void create(Connection conn, Position valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO Position ( positionName) VALUES (?) ";
               stmt = conn.prepareStatement(sql);
     ...
     */
    public List searchMatching(Connection conn, Position valueObject) throws SQLException {

          List searchResults;

          boolean first = true;
          StringBuffer sql = new StringBuffer("SELECT * FROM tb_position WHERE 1=1 ");

          if (valueObject.getPositionId() != 0) {
              if (first) { first = false; }
              sql.append("AND positionId = ").append(valueObject.getPositionId()).append(" ");
          }

          if (valueObject.getPositionName() != null) {
              if (first) { first = false; }
              sql.append("AND positionName LIKE '").append(valueObject.getPositionName()).append("%' ");
          }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Position valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setPositionName(result.getString("positionName")); 
                    ...
                    //System.out.println("Position Object Not Found!");
                    throw new NotFoundException("Position Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
	...
	public String getPositionNameById(int positionId) throws SQLException {
		...
		List searchResult = positionDao.searchMatching(SupermarketMySql.getConnection(), new Position(positionId));
