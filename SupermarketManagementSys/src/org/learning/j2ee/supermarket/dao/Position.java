...
/**
 * Tb_position Value Object.
 * This class is value object representing database table tb_position
...
public class Position implements Cloneable, Serializable {
	...
	public Position(int positionIdIn) {
	...
	public void setPositionName(String positionNameIn) {
		this.positionName = positionNameIn;
	}
	...
	public void setAll(int positionIdIn, String positionNameIn) {
		this.positionId = positionIdIn;
		this.positionName = positionNameIn;
	}

	/**
	 * hasEqualMapping-method will compare two Tb_position instances and return
	 ...
	 */
	public boolean hasEqualMapping(Position valueObject) {
		...
		if (this.positionName == null) {
			if (valueObject.getPositionName() != null)
				return (false);
		} else if (!this.positionName.equals(valueObject.getPositionName())) {
			return (false);
		}
	...
	public String toString() {
		...
		out.append("\nclass Tb_position, mapping to table tb_position\n");
		out.append("Persistent attributes: \n");
		out.append("positionId = " + this.positionId + "\n");
		out.append("positionName = " + this.positionName + "\n");
		return out.toString();
	}
	...
	public Object clone() {
		...
		if (this.positionName != null)
			cloned.setPositionName(new String(this.positionName));
		return cloned;
	}
